...
def example_1():
    ...
    env1 = CementingSimEnv(plant_params, water_valve_params, cement_valve_params, simulation_config1, initial_slurrystate)
    env2 = CementingSimEnv(plant_params, water_valve_params, cement_valve_params, simulation_config2, initial_slurrystate)
    ...
    actions2 = create_actions(t_start=t_start, t_end=t_end, dt=dt, mode="ramp",  cement_start=0.0, cement_end=0, water_start=0, water_end=50.0)
